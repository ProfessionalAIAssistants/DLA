...
class CRMData:
    ...
    def create_product(self, **kwargs):
        ...
        # Check for NSN duplicates if NSN is provided
        if valid_fields.get('nsn'):
            duplicates = self.check_product_duplicate(valid_fields['nsn'])
            if duplicates:
                error_messages = [dup['message'] for dup in duplicates]
    ...
    def update_product(self, product_id, **kwargs):
        ...
        # Check for NSN duplicates if NSN is being updated
        if valid_fields.get('nsn'):
    ...
    def create_opportunity(self, **kwargs):
        ...
        fields = ['stage', 'state', 'bid_price', 'purchase_costs', 'packaging_shipping',
                 ...
                 'contact_id', 'account_id', 'name', 'description']
    ...
    def update_rfq(self, rfq_id, **kwargs):
        ...
        fields = ['request_number', 'status', 'notes', 'quantity', 'delivery_days', 
                 'product_id', 'account_id', 'contact_id', 'opportunity_id']
    ...
    def create_interaction(self, **kwargs):
        ...
        fields = ['subject', 'description', 'type', 'interaction_date', 'duration_minutes',
                 'location', 'outcome', 'related_to_type', 'related_to_id', 'contact_id',
                 'account_id', 'opportunity_id', 'rfq_id', 'created_by']
    ...
    def create_interaction(self, **kwargs):
        ...
        valid_fields = {
            ...
            'interaction_date': kwargs.get('interaction_date', datetime.now()),
